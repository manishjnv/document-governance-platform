...
- **PDF** (`report?format=pdf`, rebuilt Phase 14e) — cover (project
  ...
  AI recommendation with its badge, Phase 14i: one "Log fields needed"
  line per gap under the detection sketch via `plain_language.telemetry_lines`)
