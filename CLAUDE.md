...
- Full backend suite: `cd apps/api && python -m pytest` — baseline is
  **906 passed, 7 skipped** (measured 2026-08-18 after report de-branding +
  Assumptions-tab rework, run solo on edgp_test; if two sessions run the suite at once the
